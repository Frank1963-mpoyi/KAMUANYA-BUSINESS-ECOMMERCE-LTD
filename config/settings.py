...
SECRET_KEY = 'c6ae+#h)=x1#ruy3w1x2+g0%pl%q42h*b^hcerlcz0pn6gig=y'
...
DATABASES = {
    'default': {
        ...
        'NAME': os.path.join(BASE_DIR, 'db.sqlite33345'),
    }
}
...
STATIC_ROOT = os.path.join(BASE_PATH, 'store/static/includes')
